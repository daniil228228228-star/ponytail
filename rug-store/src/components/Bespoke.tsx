...
const specs = [
  ...
  {
    label: 'Срок',
    body: '8–14 недель на станке в зависимости от размера и плотности узла — точную дату дадим после эскиза.',
  },
  {
    label: 'Наценка',
    body: 'Индивидуальный размер и покраска под образец — от +25% к базовой цене за м².',
  },
];
